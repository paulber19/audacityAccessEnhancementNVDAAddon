...
from au_py3Compatibility import _unicode, iterate_items  # noqa:E402
del sys.path[-1]
...
def monitorAudioAndSelectionChanges():
	...
	def getSelectionChangeMessage(audioChangeMessage):
		...
		if _addonConfigManager .toggleAutomaticSelectionChangeReportOption(False):
			...
			((selectionStartLabel, selectionStartTime), (selectionEndLabel, selectionEndTime), selectionDuration, selectionCenter) = newSelection  # noqa:E501
			((selectionStartLabel, oldSelectionStartTime), (selectionEndLabel, oldSelectionEndTime), selectionDuration, selectionCenter) = GB_selection  # noqa:E501
...
class SettingSelectionTimerControlDigit(TimerControlDigit):
	...
	def script_application(self, gesture):
		speech.speakMessage("Disabled by add-on: format must be modified  in selection toolbar")  # noqa:E501
		# gesture.send()
