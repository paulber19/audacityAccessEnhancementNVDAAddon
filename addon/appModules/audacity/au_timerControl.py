...
_selectionFormatIDs = {
	...
	"hh:mm:ss + NTSC drop frames" : 10, # 00 h 00 m 00 s+000 frames
...
_selectionFormats = {
	...
	"hh:mm:ss + samples": (7, format_HHMMSS_samples), # 00 h 00 m 01 s+00000 samples
	"samples": (2, format_samples), # 000,000,000 samples
	"hh:mm:ss + film frames (24 fps)": None, # 00 h 00 m 00 s+00 frames
